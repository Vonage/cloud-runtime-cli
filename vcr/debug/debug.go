...
func NewCmdDebug(f cmdutil.Factory) *cobra.Command {
	...
	cmd.Flags().IntVarP(&opts.AppPort, "app-port", "a", defaultAppPort, "Application port")
	cmd.Flags().IntVarP(&opts.DebuggerPort, "debugger-port", "d", defaultDebuggerPort, "Debugger CLI server port")
